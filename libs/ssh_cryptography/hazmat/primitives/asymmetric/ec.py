...
from ssh_cryptography.exceptions import UnsupportedAlgorithm, _Reasons
from ssh_cryptography.hazmat._oid import ObjectIdentifier
from ssh_cryptography.hazmat.bindings._rust import openssl as rust_openssl
from ssh_cryptography.hazmat.primitives import _serialization, hashes
...
class ECDSA(EllipticCurveSignatureAlgorithm):
    def __init__(
        ...
        from ssh_cryptography.hazmat.backends.openssl.backend import backend
