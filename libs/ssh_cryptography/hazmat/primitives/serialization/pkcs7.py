...
from ssh_cryptography import utils, x509
from ssh_cryptography.exceptions import UnsupportedAlgorithm, _Reasons
from ssh_cryptography.hazmat.bindings._rust import pkcs7 as rust_pkcs7
from ssh_cryptography.hazmat.primitives import hashes, serialization
from ssh_cryptography.hazmat.primitives.asymmetric import ec, padding, rsa
from ssh_cryptography.utils import _check_byteslike
...
class PKCS7EnvelopeBuilder:
    def __init__(
        ...
        *,
        ...
        from ssh_cryptography.hazmat.backends.openssl.backend import (
            backend as ossl,
        )
