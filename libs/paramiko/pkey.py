...
from ssh_cryptography.hazmat.backends import default_backend
from ssh_cryptography.hazmat.primitives import padding, serialization
from ssh_cryptography.hazmat.primitives.ciphers import algorithms, modes, Cipher
from ssh_cryptography.hazmat.primitives import asymmetric
...
try:
    from ssh_cryptography.hazmat.decrepit.ciphers.algorithms import TripleDES
except ImportError:
    from ssh_cryptography.hazmat.primitives.ciphers.algorithms import TripleDES
